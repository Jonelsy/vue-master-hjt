<template>
  <div>
    ...
    <el-button type="primary" @click="addCheckItems('ruleForm')" v-if="this.title=='新增套餐'">新 增</el-button>
    <el-button type="primary" @click="changeCheckItems('ruleForm')" v-if="this.title=='编辑套餐'"> 编 辑</el-button>
  </span>
  ...
  methods:{
    ...
    handleClick() {
      ...
      this.tableData2.forEach((item)=>{
        this.checkgroupIds.forEach((val)=>{
          if (val===item.id){
            list.push(item);
          }
        })
        ...
        if (valid) {
          ...
          this.$axios
              .post("/tsetmeal/save",{
                ...
                tchecckgroupIds : this.multipleSelection2,
              })
              .then((res)=>{
                this.loading=false;
                this.getCheckItems();
        ...
        if (valid) {
          ...
          this.$axios
              .post("/tsetmeal/update",{
                age: this.ruleForm.age,
                attention: "",
                checkgroupIds: this.multipleSelection2,
                code: this.ruleForm.code,
                helpcode:this.ruleForm.helpcode,
                id: this.ruleForm.id,
                img: "",
