    ...
    <div id="table">
      <el-table
        ...
        <el-table-column
          ...
          width=120>
          <span>
            <el-button @click="onEditClick($index)" type="text" >编辑</el-button>
            <el-button @click="onDelClick($index)" type="text" >删除</el-button>
          </span>
        </el-table-column>
      </el-table>
    </div>
    <el-dialog :title="dialogTitle" v-model="isDialogShow" >
      <el-form :model="form">
